 ...
 * @returns {Element[]} Řádek soupisky
 */
function GenerateRowOfSoupiskaWithQualification(pozice, jmeno, pomerDvouhra, pomerCtyrhra, pomerDvouhraKval, pomerCtyrhraKval) {
    ...
    popisKval.innerHTML = "Kvalifikace";
...
else if(path.startsWith("/htm/druzstvo.php"))
{
    ...
    for (var i = 0; i < brs.length-1; i++) {
        ...
        {
            var trs = GenerateRowOfSoupiskaWithQualification(position, jmeno, pomerDvouhry, pomerCtyrhry, pomerDvouhryKval, pomerCtyrhryKval);
            if(i%2 == 1)
            {
